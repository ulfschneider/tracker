Meteor.tracker = {
    ...
    analyzeTrack: function (track) {
        ...
        if (date) {
            ...
            if (date.length > 1) {
                failure.push("Multiple date entries are not allowed: " + Meteor.tracker.arrayPrint(date, " ", 1));
            }
        }
        ...
        if (time) {
            ...
            if (time.length > 1) {
                failure.push("Multiple time entries are not allowed: " + Meteor.tracker.arrayPrint(time, " ", 1));
            }
        }
        ...
        if (workout) {
            ...
            if (workout.length > 1) {
                failure.push("Multiple workouts are not allowed: " + Meteor.tracker.arrayPrint(workout, " ", 1));
            }
        } else {
