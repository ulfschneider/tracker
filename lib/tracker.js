Meteor.tracker = {
    ...
    _analyzeDate: function (analyze) {
        ...
        var trackDate = {
            year: analyze.data.date.getFullYear(),
            month: analyze.data.date.getMonth(),
            date: analyze.data.date.getDate(),
            hour: analyze.data.date.getHours(),
            minute: analyze.data.date.getMinutes(),
            second: 0
        };
        ...
        if (dates.length) {
            ...
            analyze.data.date = moment(trackDate).toDate();
