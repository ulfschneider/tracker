...
Meteor.chart = {
    ...
    _drawDurationLine: function (chartData, g, trackBucket) {
        if (trackBucket.tracks.length > 1) {
            ...
            var trend = [{date: new Date(coef.min.x), duration: coef.min.y}, {
                ...
                .on("mouseover", function (d, i) {
                    ...
                    chartData.d3Chart.append("text")
                        ...
                        .attr("transform", "translate("
                            + Meteor.chart._adaptTooltipXTransform(chartData, x, d3.select("#" + id + "-text").node().getBBox().width) + ","
                            + Meteor.chart._adaptTooltipYTransform(chartData, y, d3.select("#" + id + "-text").node().getBBox().height) + ")");
